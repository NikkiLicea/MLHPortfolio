...
class TestTimelinePost(unittest.TestCase):
	def setUp(self):
		...
		# need recursively bind dependencies.
	...
	def tearDown(self):
		# Not strictly necessary since SQLite in-memory databases only live for the duration of
		# the connection, and in the next step we close the connection..but a good practice all
		# the same
